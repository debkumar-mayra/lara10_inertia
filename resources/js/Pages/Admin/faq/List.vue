            ...
            <Table :ListData="faqs">
                ...
                <template #TableButton>
                    <Link
                        ...
                        class="btn btn-button kt-btn btn-sm kt-btn--icon button-fx"
                        >+ Add New</Link
                    >
                </template>
                ...
                <template #TableHead>
                    <TableTh @click="ListHelper.sortBy('question')">
                        ...
                        <input
                            class="mr-2"
                            type="checkbox"
                            @click.stop="checkedAll = !checkedAll"
                        />

                        Question</TableTh
                    >
                    <TableTh @click="ListHelper.sortBy('answer')"
                        >Answer</TableTh
                    >
                    <TableTh @click="ListHelper.sortBy('created_at')"
                        >Created at</TableTh
                    >
                ...
                <template #TableBody>
                    ...
                    <tr
                        role="row"
                        v-if="Object.keys(faqs.data).length == 0"
...
onMounted(() => {
    emit.emit("pageName", "FAQ Management", [
        { title: "FAQ", routeName: "admin.faq.index" },
    ]);
