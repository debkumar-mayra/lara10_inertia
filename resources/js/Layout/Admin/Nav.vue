<template lang="">
    ...
    <button
        ...
        v-if="mobileMenuHideShow"
        @click="mobileMenuHideShow = !mobileMenuHideShow"
    ...
    <div
        ...
        :class="{ 'kt-aside--on': mobileMenuHideShow }"
        id="kt_aside"
    >
        <!-- begin:: Aside -->
                ...
                >
                    <ul class="kt-menu__nav">
                        ...
                        <li
                            ...
                            :class="{
                                'kt-menu__item--active':
                                    $page.component.startsWith('Admin/user'),
                            }"
                            aria-haspopup="true"
                        >
                            <Link
                        ...
                        <li
                            ...
                            :class="{
                                'kt-menu__item--active':
                                    $page.component.startsWith('Admin/cms'),
                            }"
                            aria-haspopup="true"
                        >
                            <Link
                        ...
                        <li
                            ...
                            :class="{
                                'kt-menu__item--active':
                                    $page.component.startsWith('Admin/faq'),
                            }"
                            aria-haspopup="true"
                        >
                            <Link
                        ...
                        <li
                            ...
                            :class="{
                                'kt-menu__item--active':
                                    $page.component.startsWith('Admin/setting'),
                            }"
                            aria-haspopup="true"
                        >
                            <Link
