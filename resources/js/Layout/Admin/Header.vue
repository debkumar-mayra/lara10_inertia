                ...
                >
                    <form>
                        ...
                        <div
                            ...
                            style="
                                background-image: admin_assets/media/misc/bg-1.jpg;
                            "
                        >
            ...
            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                ...
                >
                    <div class="kt-header__topbar-user">
                        ...
                        <span
                            class="kt-hidden kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold"
                        ></span>
                    </div>
                </div>
                <div
                ...
                >
                    ...
                    >
                        <div class="kt-user-card__avatar">
                            ...
                            <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                            <span
                                class="kt-hidden kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"
                                >AA</span
                            >
                        </div>
